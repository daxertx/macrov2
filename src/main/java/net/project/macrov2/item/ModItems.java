...
public class ModItems {
    ...
    public static final Item SHADOW_HELMET = registerItem("shadow_helmet",new ModArmorItem(ModArmorMaterials.SHADOW_ARMOR_MATERIAL,ArmorItem.Type.HELMET,new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(16)).rarity(Rarity.RARE)));
    public static final Item SHADOW_CHESTPLATE = registerItem("shadow_chestplate",new ArmorItem(ModArmorMaterials.SHADOW_ARMOR_MATERIAL,ArmorItem.Type.CHESTPLATE,new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(16)).rarity(Rarity.RARE)));
